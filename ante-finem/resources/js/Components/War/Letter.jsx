...
export default function Letter_js() {
  const decodedWords = [
    ...
    "Skupic", "atak", "na", "sektorze", "B-19", "Wzmocnic", "sily",
    "pancerne", "Zabezpieczyc", "mosty", "na", "rzece", "Dniepr",
    "Zakonczenie", "operacji", "planowane", "na", "20:00"
  ];
  ...
  const areAllCorrect = () => {
    return encodedWords.every((_, index) =>
