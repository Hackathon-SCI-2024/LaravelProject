		...
		<div className="antique-container">
			...
			<div className="ml-2">
				<div className="bg-white rounded-lg">
					<button onClick={() => makeDecision("Give the child to the woman on the left")}>Daj dziecko kobiecie po lewej stronie.</button>
				</div>
				<br />
				<div>
					<div className="bg-white rounded-lg">
				...
				<div>
					<div className="bg-white rounded-lg">
						<button onClick={() => makeDecision("Give half of the child to each woman")}>Daj połowę dziecka każdej kobiecie.</button>
					</div>
				</div>
			</div>
			...
			<div
				...
				onClick={() => openPopup("Smutna kobieta", "Ta kobieta wygląda na załamana, ale twierdzi, że dziecko jest jej.")}
			>
				<img src={woman_sad} alt="Sad woman" />
			</div>
			<div
				className="picture_moms mother-right"
				onClick={() => openPopup("Kobieta z dzieckiem", "Ta kobieta trzyma dziecko i upiera się, że to jej.")}
			>
